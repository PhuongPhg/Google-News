  ...
  const getNews = async () => {
    ...
    try {
      const response = await fetch(
        `https://newsapi.org/v2/top-headlines?sources=${route.params?.id}&apiKey=b79f085de40249e28b6c0f3f0d1c7ebd&page=${pageNumber}`
      )
      console.log('sources pa',route.params?.id);
